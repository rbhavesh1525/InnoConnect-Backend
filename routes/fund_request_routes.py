...
from models.fund_request_model import (
    FundRequestCreate
)

from fastapi import HTTPException

from services.fund_request_service import (
    send_fund_request,
...
async def send_request(
    request: FundRequestCreate,
    current_user=Depends(get_current_user)
):
    sender_id = current_user["user_id"]

    result = send_fund_request(
        sender_id,
        request.receiver_id,
        request.project_id
    )
