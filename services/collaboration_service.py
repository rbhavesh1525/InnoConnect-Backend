...
def send_collaboration_request(sender_id, receiver_id, project_id):
...
def accept_request(request_id: str, receiver_id: str):
    ...
    return {
        ...
        "notification_message": (
            f'I accepted your collaboration request for "{project_title}".'
        ),
    }
...
def reject_request(request_id: str, receiver_id: str):
    ...
    return {
        ...
        "request": request,
        "notification_message": (
            f'I declined your collaboration request for "{project_title}".'
        ),
    }